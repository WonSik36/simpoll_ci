...
$route['api/group/(:any)'] = 'group/restWithParam/$1';
$route['api/choice'] = 'choice/rest';
$route['api/group'] = 'group/makeGroup';
$route['api/room'] = 'room/makeRoom';
$route['api/vote/(:num)'] = 'vote/deleteVote/$1';
$route['api/choice/(:num)'] = 'choice/updateChoice/$1';
